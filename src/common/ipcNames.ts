const modules = {
  common: {
    ...
    read_custom_font: 'read_custom_font',
  ...
  player: {
    ...
    list_trash_get: 'list_trash_get',
    list_trash_restore: 'list_trash_restore',
    list_trash_delete: 'list_trash_delete',
    list_trash_changed: 'list_trash_changed',
  },
  dislike: {
