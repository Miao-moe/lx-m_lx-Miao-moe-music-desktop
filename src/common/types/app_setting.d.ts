...
declare global {
  ...
  declare namespace LX {
    ...
    interface AppSetting {
      ...
      /**
       * 网易云音乐 Cookie（用于歌单/播放记录同步，不解锁音质）
       */
      'cookie.wy': string

      /**
       * QQ 音乐 Cookie（用于歌单/播放记录同步，不解锁音质）
       */
      'cookie.tx': string

      /**
       * 酷狗音乐 Cookie（用于歌单/播放记录同步，不解锁音质）
       */
      'cookie.kg': string

      /**
       * 酷我音乐 Cookie（用于歌单/播放记录同步，不解锁音质）
       */
      'cookie.kw': string
       ...
       */
      'cookie.enablePlayHistorySync': boolean

      /**
       * 是否将收藏歌单同步回各音乐平台（基于 Cookie）
       */
       ...
       */
      'player.gaplessPlayback': boolean

      /**
       * 是否启用歌曲切换渐入渐出（fade-in / fade-out）
       */
      'player.fadeInFadeOut': boolean
