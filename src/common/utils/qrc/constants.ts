...
// 解密使用的3个8字节的DES密钥
export const KEY_1: Uint8Array<ArrayBuffer> = new TextEncoder().encode(
  '!@#)(*$%',
)
export const KEY_2: Uint8Array<ArrayBuffer> = new TextEncoder().encode(
  '123ZXC!@',
)
export const KEY_3: Uint8Array<ArrayBuffer> = new TextEncoder().encode(
  '!@#)(NHL',
)
