<template>
  <div :class="$style.contnet">
    ...
    <div :class="$style.convolution">
      ...
      <SettingReveal :show="!disabledConvolution" :depends="convolutionControls">
    ...
    <div :class="$style.saveList">
      ...
      <SettingReveal v-if="userPresetList.length < 31" :show="!disabledConvolution" :depends="convolutionControls">
...
const convolutionControls = convolutions.map(item => `player__convolution_${item.name}`).join(' ')
