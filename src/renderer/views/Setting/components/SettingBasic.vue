...
dd
  div
    ...
    common-setting-reveal(:show="appSetting['common.isShowAnimation']" depends="setting_show_animate")
      .gap-top
...
quality-check-modal(v-model="isShowQualityCheckModal")
</template>
...
export default {
  ...
  setup(props) {
    ...
    const isShowQualityCheckModal = ref(false)
    const getApiStatus = () => {
      let status
