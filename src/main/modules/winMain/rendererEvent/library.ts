...
const allowed = new Set(['getLibraryPreferences', 'saveLibraryPreferences', 'getListeningHistory', 'removeListeningHistory', 'clearListeningHistory', 'recordListening', 'getDatabaseCacheSizes'])
export default () => {
